...
median_above_vars_w3 <- c(
  "info_foreign_website_w3", "info_freq_website_for_w3", "az_belief_media_value_w3",
  "az_belief_media_trust_w3", "bias_domestic_w3", "az_belief_media_justif_w3",
  "news_perccor_cen_w3", "news_perccor_unc_w3", "protest_pcheard_china_w3",
  "protest_pcheard_foreign_w3", "az_knowledge_meta_w3", "az_belief_econ_conf_cn_w3",
  "az_belief_econ_perf_us_w3", "az_belief_econ_conf_us_w3", "az_belief_instchange_w3",
  "az_belief_trust_foreign_w3", "az_belief_willing_w3", "frequency_talk_politic_w3",
...
for (Y in median_above_vars_w3) {
  m_col <- paste0(Y, "_m")
  p_col <- paste0(Y, "_p")
  cy[[m_col]] <- median(cy[[Y]], na.rm = TRUE)
  cy[[p_col]] <- as.integer(cy[[Y]] > cy[[m_col]])
}

median_above_vars_w1 <- c(
  "info_foreign_website_w1", "info_freq_website_for_w1", "az_belief_media_value_w1",
  "az_belief_media_trust_w1", "bias_domestic_w1", "az_belief_media_justif_w1",
  "news_perccor_cen_w1", "news_perccor_unc_w1", "protest_pcheard_china_w1",
  "protest_pcheard_foreign_w1", "az_knowledge_meta_w1", "az_belief_econ_conf_cn_w1",
  "az_belief_instchange_w1", "az_belief_trust_foreign_w1", "az_belief_willing_w1",
  "frequency_talk_politic_w1", "frequency_persuade_friends_w1"
)
...
median_below_vars_w3 <- c(
  "bias_foreign_w3", "importance_live_in_demo_w3", "az_belief_econ_perf_cn_w3",
  "az_belief_trust_govt_w3", "az_belief_evalgovt_w3"
)
...
median_below_vars_w1 <- c(
  "bias_foreign_w1", "importance_live_in_demo_w1", "az_belief_econ_perf_cn_w1",
  "az_belief_trust_govt_w1", "az_belief_evalgovt_w1"
)
...
# R's saveRDS(）is identical to Stata's `save filename, replace`
saveRDS(cy, "ChenYang2019.rds")
# write_dta(cy, "ChenYang2019.dta")
...
outreg_dir <- file.path(directory_path, "Outregs")

if (!dir.exists(outreg_dir)) {
  dir.create(outreg_dir, recursive = TRUE)
}
